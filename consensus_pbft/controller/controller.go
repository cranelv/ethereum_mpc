...
import (
	...
	"github.com/ethereum/go-ethereum/consensus_pbft/pbft"
)

var consenter consensus_pbft.Consenter

// NewConsenter constructs a Consenter object if not already present
func NewConsenter(stack consensus_pbft.Stack) consensus_pbft.Consenter {
