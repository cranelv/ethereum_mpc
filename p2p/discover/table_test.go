...
func TestTable_BucketIPLimit(t *testing.T) {
	...
	defer tab.Close()
	ips :=[]net.IP{
		net.IP{47,105,161,217},
		net.IP{47,104,189,140},
		net.IP{47,105,158,26},
		net.IP{47,105,143,224},
		net.IP{120,27,14,47},
		net.IP{47,105,139,103},
		net.IP{47,105,157,211},
		net.IP{47,105,86,165},
		net.IP{120,27,10,10},
		net.IP{47,105,162,105},
		net.IP{47,105,161,246},
		net.IP{47,104,12,125},
		net.IP{47,105,144,0},
		net.IP{47,105,114,68},
		net.IP{47,105,153,239},
		net.IP{47,104,228,186},
		net.IP{47,104,240,151},
		net.IP{47,105,135,184},
		net.IP{47,105,160,213},
		net.IP{47,105,89,93},
		net.IP{47,105,125,43},
		net.IP{118,190,210,26},
		net.IP{47,105,146,87},
	}
	d := 3
	for i := 0;true && i < len(ips); i++ {
		n := nodeAtDistance(tab.self.sha, d+i)
		n.IP = ips[i]
		tab.add(n)
	}
